...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800">
      ...
      <section
        id="hero-section"
        className="relative h-screen flex items-center justify-center overflow-hidden pt-16 bg-gradient-to-br from-indigo-800 to-purple-800"
      >
        {/* Video Wrapper */}
        <div className="absolute inset-0 w-full h-full">
          {/* Smooth Gradient Overlay */}
          <div
            className={`absolute inset-0 bg-gradient-to-br from-indigo-900/70 to-purple-900/50 z-10 transition-opacity duration-1000 ${isVideoLoaded ? "opacity-100" : "opacity-0"
              }`}
          />
          ...
          {videoError && (
            <div className="absolute inset-0 bg-gradient-to-br from-indigo-700 to-purple-700 z-0 transition-opacity duration-700 opacity-100" />
          )}
        </div>
        ...
        <div className="relative z-20 text-center text-white px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto w-full">
          ...
          >
            ...
            <motion.p
              variants={itemVariants}
              className="text-base sm:text-lg md:text-xl text-gray-200 max-w-2xl mx-auto leading-relaxed font-light"
            >
            ...
            >
              ...
              <Link href="/demo">
                <Button
                  size="lg"
                  variant="ghost"
                  className="border-2 border-white hover:bg-white/20 font-semibold text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-5 rounded-xl sm:rounded-2xl backdrop-blur-sm transition-all duration-300 hover:scale-105"
                >
            ...
            <motion.div
              variants={itemVariants}
              className="flex flex-col sm:flex-row items-center justify-center space-y-1 sm:space-y-0 sm:space-x-6 text-xs sm:text-sm text-gray-300"
            >
